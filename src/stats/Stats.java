...
/**
 * La clase Stats extiende la clase Estadisticas y proporciona una instancia única para el seguimiento de estadísticas.
 */
public class Stats extends Estadisticas{
    ...
    /**
     * Constructor privado para crear una instancia de Stats con los nombres de las estadísticas especificados.
     *
